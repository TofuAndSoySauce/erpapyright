...
<script type="text/javascript">
	...
	function showChart(data){
		...
		//mm_rev_area.grouplist1 = data;
		//mm_rev_area.mmRevenuelist1 = data;
	}
</script>
				...
				<ul>
					...
					<li class="contents">
						...
						<div class="content">
							...
							<div v-for="(list, item) in mmRevenuelist">
								{{ addToarray(list) }}	
					...
					<%--	<c:if test="${not empty mmRevenuelist}">
							...
							<div class="divmmRevList">			
								<table id="mmRevtable_main" class="col">						
									...
									<!-- <template v-for="(list, index) in mmRevenuelist1">
									<thead>
										<tr>
											<th scope="row">111</th>
											<th scope="row">{{list.ym_date}}</th>
										</tr> 
									</thead>
									...
									<thead>
										<tr>
											<th scope="row">111</th>
											<th scope="row" v-for="(list, index) in mmRevenuelist1">{{list.ym_date}}</th>
										</tr> 
									</thead>

									<tbody>
										<tr>
											<td scope="row">주문건수</td> <td scope="row" v-for="(list, index) in mmRevenuelist1">{{list.order_amt}}(건)</td>
										</tr>
										<tr>
											<td scope="row">매출</td> <td scope="row" v-for="(list, index) in mmRevenuelist1">{{list.outgo}}</td>
										</tr>
										<tr>
											<td scope="row">영업비</td> <td scope="row" v-for="(list, index) in mmRevenuelist1">{{list.outgo}}</td>
										</tr>
										<tr>
											<td scope="row">영업이익</td> <td scope="row" v-for="(list, index) in mmRevenuelist1">{{list.sales_exp}}</td>
										</tr>
										<tr>
											<td scope="row">영업이익률</td> <td scope="row" v-for="(list, index) in mmRevenuelist1">{{list.profit_rate}}</td>
										</tr>
                               			<!-- <tr>
                           					<td scope="col">{{list.order_amt}}(건)</td>
                           					<td scope="col">{{list.outgo}}</td>
									...
									<colgroup>
                               		...
                               		<tbody>
										<tr>
                               			...
                               			<tr v-for="(list, item) in mmRevenuelist2">
